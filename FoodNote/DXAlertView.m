...
#define kButtonBottomOffset 10.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:80.0/255.0 green:210.0/255.0 blue:150.0/255.0 alpha:1]] forState:UIControlStateNormal];
